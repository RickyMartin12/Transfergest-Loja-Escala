            ...
            // Ao Motorista
                ...
                if ($_SESSION["payments"] =='Driver')
                {
                 ...
                 $timev = strtotime($date_array1[2].'-'.$date_array1[1].'-'.$date_array1[0].' '.$date_hour_array1[1]);
                    ...
                    VALUES ( '$servico', $date, $timeok_flight_date, '{$_SESSION["voo_n_che"]}', '{$_SESSION["nome"]}', '{$_SESSION["email"]}', '$pick ', '$pick2','{$_SESSION["adult"]}', '{$_SESSION["children"]}', '{$_SESSION["baby"]}', '$obs', 'Direto', $val, '".date("Y-m-d H:i:s")."', '$referencia', '{$_SESSION["tel"]}', '{$_SESSION["country"]}','{$_SESSION["dominio"]}', $duration, 'Pendente', '{$_SESSION["navigator"]}', '{$_SESSION["coord1"]}', '{$_SESSION["coord2"]}', '-/-', '{$_SESSION["voo_che_mor"]}', '{$_SESSION["voo_dep_mor"]}', '$gerado')"; 
                    ...
                    if ($success)
                    {
                        ...
                        $date_hour_array=explode(' ',trim($_SESSION["voo_dep_pick"]));
                        $date_array = explode('/', $date_hour_array[0]);
                        ...
                        VALUES ( '$servico', $date, $timeok, '$voo', '{$_SESSION["nome"]}', '{$_SESSION["email"]}', '$pick', '$pick2','{$_SESSION["adult"]}', '{$_SESSION["children"]}', '{$_SESSION["baby"]}', '$obs', 'Direto', 0, '".date("Y-m-d H:i:s")."', '$referencia', '{$_SESSION["tel"]}', '{$_SESSION["country"]}','{$_SESSION["dominio"]}', $duration, 'Pendente', '{$_SESSION["navigator"]}', '{$_SESSION["coord2"]}', '{$_SESSION["coord1"]}', $timev, '{$_SESSION["voo_dep_mor"]}', '{$_SESSION["voo_che_mor"]}', '$gerado')"; 
                ...
                if ($_SESSION["payments"] =='Bank')
                {
                 ...
                 $timev = strtotime($date_array1[2].'-'.$date_array1[1].'-'.$date_array1[0].' '.$date_hour_array1[1]);
                    ...
                    VALUES ( '$servico', $date, $timeok_flight_date, '{$_SESSION["voo_n_che"]}', '{$_SESSION["nome"]}', '{$_SESSION["email"]}', '$pick ', '$pick2','{$_SESSION["adult"]}', '{$_SESSION["children"]}', '{$_SESSION["baby"]}', '$obs', 'Site Transf.Banco', $val, '".date("Y-m-d H:i:s")."', '$referencia', '{$_SESSION["tel"]}', '{$_SESSION["country"]}','{$_SESSION["dominio"]}', $duration, 'Pendente', '{$_SESSION["navigator"]}', '{$_SESSION["coord1"]}', '{$_SESSION["coord2"]}', '-/-', '{$_SESSION["voo_che_mor"]}', '{$_SESSION["voo_dep_mor"]}', '$gerado')"; 
                    ...
                    if ($success)
                    {
                        ...
                        VALUES ( '$servico', $date, $timeok, '$voo', '{$_SESSION["nome"]}', '{$_SESSION["email"]}', '$pick', '$pick2','{$_SESSION["adult"]}', '{$_SESSION["children"]}', '{$_SESSION["baby"]}', '$obs', 'Site Transf.Banco', 0, '".date("Y-m-d H:i:s")."', '$referencia', '{$_SESSION["tel"]}', '{$_SESSION["country"]}','{$_SESSION["dominio"]}', $duration, 'Pendente', '{$_SESSION["navigator"]}', '{$_SESSION["coord2"]}', '{$_SESSION["coord1"]}', $timev, '{$_SESSION["voo_dep_mor"]}', '{$_SESSION["voo_che_mor"]}', '$gerado')"; 
                ...
                if ($_SESSION["payments"] =='Paypal') // Leva muito tempo a excutar
                {
                 ...
                 $timev = strtotime($date_array1[2].'-'.$date_array1[1].'-'.$date_array1[0].' '.$date_hour_array1[1]);
                    ...
                    VALUES ( '$servico', $date, $timeok_flight_date, '{$_SESSION["voo_n_che"]}', '{$_SESSION["nome"]}', '{$_SESSION["email"]}', '$pick', '$pick2','{$_SESSION["adult"]}', '{$_SESSION["children"]}', '{$_SESSION["baby"]}', '$obs', 'Site Paypal', $val, '".date("Y-m-d H:i:s")."', '$referencia', '{$_SESSION["tel"]}', '{$_SESSION["country"]}','{$_SESSION["dominio"]}', $duration, 'Pendente', '{$_SESSION["navigator"]}', '{$_SESSION["coord1"]}', '{$_SESSION["coord2"]}', '-/-', '{$_SESSION["voo_che_mor"]}', '{$_SESSION["voo_dep_mor"]}', '$gerado')"; 
                    ...
                    if ($success)
                    {
                        ...
                        $new_arrival = "INSERT INTO excel
                        (servico,data_servico, hrs, voo, nome_cl, email, local_recolha, local_entrega, px, cr, bebe, obs,operador,cobrar_operador,data_criacao, referencia, telefone, pais, criado_direto, end, estado, navigator, morada_recolha_gps, morada_entrega_gps, voo_horario, morada_recolha, morada_entrega, created_by)
                        VALUES ( '$servico', $date, $timeok, '$voo', '{$_SESSION["nome"]}', '{$_SESSION["email"]}', '$pick','$pick2' ,'{$_SESSION["adult"]}', '{$_SESSION["children"]}', '{$_SESSION["baby"]}', '$obs', 'Site Paypal', 0, '".date("Y-m-d H:i:s")."', '$referencia', '{$_SESSION["tel"]}', '{$_SESSION["country"]}','{$_SESSION["dominio"]}', $duration, 'Pendente', '{$_SESSION["navigator"]}', '{$_SESSION["coord2"]}', '{$_SESSION["coord1"]}', $timev, '{$_SESSION["voo_dep_mor"]}', '{$_SESSION["voo_che_mor"]}', '$gerado')"; 
