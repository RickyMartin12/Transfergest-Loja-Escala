...
$pick = $_SESSION["from"].' - '.$_SESSION["voo_dep_mor"];
...
$obs = '('. $_SESSION["pax"] .') '.$referencia.' | MTR | OBS: '. $_SESSION["obs"].' Pickup Recommended/Recomendado: '.$_SESSION["pickup_recommended"];

$voo = $_SESSION["voo_n_dep"].' @ '.date("H:i",$timev);
...
$obs = '('. $_SESSION["pax"] .') '.$referencia.' | TB | OBS: '. $_SESSION["obs"].' Pickup Recommended/Recomendado: '.$_SESSION["pickup_recommended"];
...
$obs = '('. $_SESSION["pax"] .') '.$referencia.' | PP | OBS: '. $_SESSION["obs"].' Pickup Recommended/Recomendado: '.$_SESSION["pickup_recommended"];
