...
case '1':
        ...
        if ($_POST['coord3'] != "") 
        {
            $_POST['coord3'] = filter_var($_POST['coord3'], FILTER_SANITIZE_STRING);
            $_SESSION["coord3"] = $_POST['coord3'];
        }
  ...
  if ($_POST['label'] != "") {
     ...
     /*VALIDAR MORADA CHEGADA E ATRIBUIR VAR SESSÃO*/
        ...
        /*VALIDAR MORADA CHEGADA E ATRIBUIR VAR SESSÃO*/
        if ($_POST['voo_dep_mor2'] != "") {
            $_POST['voo_dep_mor2'] = filter_var($_POST['voo_dep_mor2'], FILTER_SANITIZE_STRING);
            $_SESSION["voo_dep_mor2"] = $_POST['voo_dep_mor2'];
        }
...
/**/
     ...
     /*VALIDAR MORADA PARTIDA E ATRIBUIR VAR SESSÃO*/
        ...
        /*VALIDAR MORADA CHEGADA E ATRIBUIR VAR SESSÃO*/
        if ($_POST['voo_dep_mor3'] != "") {
            $_POST['voo_dep_mor3'] = filter_var($_POST['voo_dep_mor3'], FILTER_SANITIZE_STRING);
            $_SESSION["voo_dep_mor3"] = $_POST['voo_dep_mor3'];
        }
...
$baby = filter_var($_POST['baby'], FILTER_SANITIZE_NUMBER_INT);
        ...
        if ($errors == "") {
          // Valores de Retorno do Formulário a JSON
            ...
            'voo_dep_mor2' => $_SESSION["voo_dep_mor2"],
            'coord1' => $_SESSION['coord1'],
            'coord3' => $_SESSION['coord3'],

            'voo_dep_dt' => $_SESSION["voo_dep_dt"],
            'voo_dep_mor' => $_SESSION["voo_dep_mor"],
            'voo_dep_mor4' => $_SESSION["voo_dep_mor4"],
            ...
            if ($_SESSION["payments"] =='Driver')
            {
                ...
                $timeok_flight_date = strtotime($date_array[2].'-'.$date_array[1].'-'.$date_array[0].' '.$date_hour_array[1]);

                $obs = 'TEM RETORNO ' .$referencia. ' ('. $_SESSION["pax"] .') ' .' | MTR | OBS: '. $_SESSION["obs"];

                $gerado = $_SESSION["dominio"].'@'.date("Y-m-d H:i:s");

                $new_arrival = "INSERT INTO excel(servico, data_servico, hrs, nome_cl, email, local_recolha, local_entrega, px, cr, bebe, obs,operador,cobrar_direto,data_criacao, referencia, telefone, pais, criado_direto, end, estado, navigator, morada_recolha_gps, morada_entrega_gps, voo_horario, morada_recolha, morada_entrega, created_by)
                VALUES ( '$servico', $date, $timeok_flight_date, '{$_SESSION["nome"]}', '{$_SESSION["email"]}', '$pick', '$pick2','{$_SESSION["adult"]}', '{$_SESSION["children"]}', '{$_SESSION["baby"]}', '$obs', 'Direto', $val, '".date("Y-m-d H:i:s")."', '$referencia', '{$_SESSION["tel"]}', '{$_SESSION["country"]}','{$_SESSION["dominio"]}', $duration, 'Pendente', '{$_SESSION["navigator"]}', '{$_SESSION["coord1"]}', '{$_SESSION["coord3"]}', '-/-', '{$_SESSION["voo_che_mor"]}', '{$_SESSION["voo_dep_mor2"]}', '$gerado')"; 
                    ...
                    if ($success)
                    {
                        ...
                        $date_hour_array=explode(' ',trim($_SESSION["voo_dep_dt"]));
                        $date_array = explode('/', $date_hour_array[0]);
                        ...
                        $new_arrival = "INSERT INTO excel(servico,data_servico, hrs, nome_cl, email, local_recolha, local_entrega, px, cr, bebe, obs,operador,cobrar_direto,data_criacao, referencia, telefone, pais, criado_direto, end, estado, navigator, morada_recolha_gps, morada_entrega_gps, voo_horario, morada_recolha, morada_entrega, created_by)
                        VALUES ( '$servico', $date, $timeok, '{$_SESSION["nome"]}', '{$_SESSION["email"]}', '$pick', '$pick2','{$_SESSION["adult"]}', '{$_SESSION["children"]}', '{$_SESSION["baby"]}', '$obs', 'Direto', 0, '".date("Y-m-d H:i:s")."', '$referencia', '{$_SESSION["tel"]}', '{$_SESSION["country"]}','{$_SESSION["dominio"]}', $duration, 'Pendente', '{$_SESSION["navigator"]}', '{$_SESSION["coord3"]}', '{$_SESSION["coord1"]}', $timeok_flight_date, '{$_SESSION["voo_dep_mor"]}', '{$_SESSION["voo_dep_mor3"]}','$gerado')";  
            ...
            if ($_SESSION["payments"] =='Bank')
            {
                ...
                $date_array = explode('/', $date_hour_array[0]);
                    ...
                    $date=strtotime($date_array[2].'-'.$date_array[1].'-'.$date_array[0].'-00');
                    $timeok_flight_date = $timeok = strtotime($date_array[2].'-'.$date_array[1].'-'.$date_array[0].' '.$date_hour_array[1]);
                ...
                $new_arrival = "INSERT INTO excel(servico, data_servico, hrs, nome_cl, email, local_recolha, local_entrega, px, cr, bebe, obs,operador,cobrar_operador,data_criacao, referencia, telefone, pais, criado_direto, end, estado, navigator, morada_recolha_gps, morada_entrega_gps, voo_horario, morada_recolha, morada_entrega, created_by)
                VALUES ( '$servico', $date, $timeok_flight_date, '{$_SESSION["nome"]}', '{$_SESSION["email"]}', '$pick', '$pick2','{$_SESSION["adult"]}', '{$_SESSION["children"]}', '{$_SESSION["baby"]}', '$obs', 'Site Transf.Banco', $val, '".date("Y-m-d H:i:s")."', '$referencia', '{$_SESSION["tel"]}', '{$_SESSION["country"]}','{$_SESSION["dominio"]}', $duration, 'Pendente', '{$_SESSION["navigator"]}', '{$_SESSION["coord1"]}', '{$_SESSION["coord3"]}', '-/-', '{$_SESSION["voo_che_mor"]}', '{$_SESSION["voo_dep_mor2"]}','$gerado')";
                ...
                $new_arrival = "INSERT INTO excel(servico, data_servico, hrs, nome_cl, email, local_recolha, local_entrega, px, cr, bebe, obs,operador,cobrar_operador,data_criacao, referencia, telefone, pais, criado_direto, end, estado, navigator, morada_recolha_gps, morada_entrega_gps, voo_horario, morada_recolha, morada_entrega, created_by)
                VALUES ( '$servico', $date, $timeok, '{$_SESSION["nome"]}', '{$_SESSION["email"]}', '$pick', '$pick2','{$_SESSION["adult"]}', '{$_SESSION["children"]}', '{$_SESSION["baby"]}', '$obs', 'Site Transf.Banco', 0, '".date("Y-m-d H:i:s")."', '$referencia', '{$_SESSION["tel"]}', '{$_SESSION["country"]}','{$_SESSION["dominio"]}', $duration, 'Pendente', '{$_SESSION["navigator"]}', '{$_SESSION["coord3"]}', '{$_SESSION["coord1"]}', '-/-', '{$_SESSION["voo_dep_mor"]}', '{$_SESSION["voo_dep_mor3"]}','$gerado')";
         ...
         $result_comp = mysqli_query($conn, $obter_comp);
          if (mysqli_num_rows($result_comp) > 0) {
            ...
            $servico = 'Interzone';
                ...
                $new_arrival = "INSERT INTO excel(servico, data_servico, hrs, nome_cl, email, local_recolha, local_entrega, px, cr, bebe, obs,operador,cobrar_operador,data_criacao, referencia, telefone, pais, criado_direto, end, estado, navigator, morada_recolha_gps, morada_entrega_gps, voo_horario, morada_recolha, morada_entrega, created_by)
                VALUES ( '$servico', $date, $timeok_flight_date, '{$_SESSION["nome"]}', '{$_SESSION["email"]}', '$pick', '$pick2','{$_SESSION["adult"]}', '{$_SESSION["children"]}', '{$_SESSION["baby"]}', '$obs', 'Site Paypal', $val, '".date("Y-m-d H:i:s")."', '$referencia', '{$_SESSION["tel"]}', '{$_SESSION["country"]}','{$_SESSION["dominio"]}', $duration, 'Pendente', '{$_SESSION["navigator"]}', '{$_SESSION["coord1"]}', '{$_SESSION["coord3"]}', '-/-', '{$_SESSION["voo_che_mor"]}', '{$_SESSION["voo_dep_mor2"]}','$gerado')";
            ...
            if ($success)
            {
                ...
                $new_arrival = "INSERT INTO excel(servico, data_servico, hrs, nome_cl, email, local_recolha, local_entrega, px, cr, bebe, obs,operador,cobrar_operador,data_criacao, referencia, telefone, pais, criado_direto, end, estado, navigator, morada_recolha_gps, morada_entrega_gps, voo_horario, morada_recolha, morada_entrega, created_by)
                VALUES ( '$servico', $date, $timeok, '{$_SESSION["nome"]}', '{$_SESSION["email"]}', '$pick', '$pick2','{$_SESSION["adult"]}', '{$_SESSION["children"]}', '{$_SESSION["baby"]}', '$obs', 'Site Paypal', 0, '".date("Y-m-d H:i:s")."', '$referencia', '{$_SESSION["tel"]}', '{$_SESSION["country"]}','{$_SESSION["dominio"]}', $duration, 'Pendente', '{$_SESSION["navigator"]}', '{$_SESSION["coord3"]}', '{$_SESSION["coord1"]}', '-/-', '{$_SESSION["voo_dep_mor"]}', '{$_SESSION["voo_dep_mor3"]}', '$gerado')";
