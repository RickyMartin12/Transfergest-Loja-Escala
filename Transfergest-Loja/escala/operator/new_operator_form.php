...
$(function () {
  ...
  console.log($("input[name='dominio']").val());

  $("input[name='dominio']").attr("readonly","true");




  $('.bootstrap-switch-id-loja').on('switchChange.bootstrapSwitch', function (event, state) {
  console.log(state);
 if (state == true) {
    $("input[name='dominio']").removeAttr('readonly');
 } else {
    $("input[name='dominio']").attr("readonly","true");
 }
