...
<div class='col-md-2 col-sm-6 col-xs-6' title="Acesso a Gestão">
<div class="form-group">
<div class="input-group">
<span class="input-group-addon" style='padding: 6px 3px;'><span>Gestão</span></span>
...
<div class='col-md-2 col-sm-6 col-xs-6' title="Enviar Relatórios Diários">
<div class="form-group">
<div class="input-group">
<span class="input-group-addon" style='padding: 6px 3px;'><span>R.Diário</span></span>
<div class="form-control" style="padding: 5px 4px;">
<input type='checkbox' data-size='mini' data-off-color='danger' data-on-color='success' name='rel_diario' id='rel_diario'>
</div>
</div>
</div>
</div>
<div class='col-md-2 col-sm-6 col-xs-6' title="Enviar Relatórios Semanais">
<div class="form-group">
<div class="input-group">
<span class="input-group-addon" style='padding: 6px 3px;'><span>R.Semana</span></span>
<div class="form-control" style="padding: 5px 4px;">
<input type='checkbox' data-size='mini' data-off-color='danger' value="false" data-on-color='success' name='rel_semana' id='rel_semana'>
</div>
</div>
</div>
</div>
...
arr[i].rel_diario == 'checked' ?  rel_diario = "<p class='acess-active-cont-"+arr[i].id+"-rel_diario' style='margin:0; text-align:center;'><button onclick='acessActivate(2,"+arr[i].id+",1)' class='acess-active-"+arr[i].id+" btn btn-success btn-sm'><span class='glyphicon glyphicon-eye-open'></span></button></p>" : rel_diario = "<p class='acess-active-cont-"+arr[i].id+"-rel_diario'  style='margin:0; text-align:center;'><button onclick='acessActivate(2,"+arr[i].id+",0)' class='acess-active-"+arr[i].id+" btn btn-default btn-sm'><span class='glyphicon glyphicon-eye-close'></span></button></p>";

arr[i].rel_semana == 'checked' ?  rel_semana = "<p class='acess-active-cont-"+arr[i].id+"-rel_semana' style='margin:0; text-align:center;'><button onclick='acessActivate(3,"+arr[i].id+",1)' class='acess-active-"+arr[i].id+" btn btn-success btn-sm'><span class='glyphicon glyphicon-eye-open'></span></button></p>" : rel_semana= "<p class='acess-active-cont-"+arr[i].id+"-rel_semana'  style='margin:0; text-align:center;'><button onclick='acessActivate(3,"+arr[i].id+",0)' class='acess-active-"+arr[i].id+" btn btn-default btn-sm'><span class='glyphicon glyphicon-eye-close'></span></button></p>";
...
if (tp == 1) tps = 'gestao';
if (tp == 2) tps = 'rel_diario';
if (tp == 3) tps = 'rel_semana';
