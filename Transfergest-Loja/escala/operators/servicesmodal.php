        ...
        <div class="row servicedetails">
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="form-group">
              ...
              <select class="form-control" id="regcol_4"></select>
            </div>
          </div>
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="form-group">
              ...
              <div class="input-group" style="width:100%;">
                <input style="border-radius: 4px;" type="text" class="form-control" id="regcol_179" placeholder="Ref.Interna">
              </div>
            </div>
          </div>  
          <div class="col-md-3 col-sm-6 col-xs-12">
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="form-group">
              <label class="control-label" title="O estado em que se encontra o serviço/transfer.(Controlado pela aplicação e central)"> Estado </label>
                <select class="form-control" id="regcol_17" onchange="this.value == 'Cancelado' ? $('#deletevalues').css('display','block'): false"></select>
            </div>
          </div> 
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="form-group">
      ...
      <div class="row serviceoperator hidden">
        ...
        <label class="control-label" title="Nome do Operador (visivel na aplicação)">Operador</label>
          <div class="input-group" style="width:100%;">
            ...
            <select class="form-control" id="regcol_88"></select>
          </div>
        </div>
          ...
          <div class="col-md-6 col-xs-12">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="regcol_14" placeholder="Ticket">
            </div>
          </div> 
        </div>
        ...
        <div class="row serviceclient hidden">
          ...
          <div class="col-lg-2 col-md-4 col-xs-4">
            <div class="form-group">
              ...
              <input value="1" type="number" min="1" class="form-control" required id="regcol_10" placeholder="Total Adultos *">
            </div>
          </div>
          <div class="col-lg-2 col-md-4 col-xs-4">
            <div class="form-group">
              <label class="control-label" title="O total de crianças para o serviço/Transfer.(visivel na aplicação)">Crianças</label>
              <input type="number" min="0" class="form-control" value="0"  id="regcol_11" placeholder="Total Crianças">
            </div>
          </div>
          <div class="col-lg-2 col-md-4 col-xs-4">
            <div class="form-group">
              <label class="control-label" title="O total de bébés para o serviço/Transfer.(visivel na aplicação)">Bébés</label>
              <input type="number" min="0" class="form-control" value="0" id="regcol_12" placeholder="Total Bébés">
            </div>
          </div>
        </div>
        ...
        <div class="row servicelocations hidden">
          ...
          <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="regcol_5" placeholder="Voo">
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="form-group">
              ...
              <div class="input-group date" id="flight-date">
                <input type="text" class="form-control" id="regcol_25" placeholder="Hora Voo">
                <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
             </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="form-group">
              ...
              <div class="input-group" style="width:100%;">
                <select style="border-radius: 4px;"class="form-control" id="regcol_7"></select>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-xs-12">
            <div class="form-group">
              ...
              <div class="input-group" style="width:100%;">
                <input style="border-radius: 4px;" type="text" class="form-control" id="regcol_21" placeholder="GPS Recolha">
              </div>
            </div>
          </div>
          ...
          <div class=" col-lg-12 col-md-6 col-xs-12">
            <div class="form-group">
              ...
              <div class="input-group" style="width:100%;">
                <input style="border-radius: 4px;" type="text" class="form-control" id="regcol_20" placeholder="Morada Recolha">
              </div>
            </div>
          </div>
         ...
         <div class="col-xs-12 w3-border-bottom w3-border-dark-grey w3-margin-bottom"></div>
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="form-group">
             ...
             <div class="input-group" style="width:100%;">
                <select style="border-radius: 4px;" class="form-control" id="regcol_8"></select>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 col-xs-12">
            <div class="form-group">
              ...
              <div class="input-group" style="width:100%;">
                <input style="border-radius: 4px;" type="text" class="form-control" id="regcol_23" placeholder="GPS Entrega">
              </div>
            </div>
          </div>
          <div class="col-lg-5 col-xs-12">
            <div class="form-group">
              ...
              <div class="input-group" style="width:100%;">
                <input style="border-radius: 4px;" type="text" class="form-control" id="regcol_22" placeholder="Morada Entrega">
              </div>
            </div>
          </div>
          ...
          <div class="col-md-12 col-xs-12">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="regcol_13" placeholder="Obs">
            </div>
          </div>
          ...
          <div class="col-md-12 col-xs-12">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="regcol_9" placeholder="Ponto de Referência">
            </div>
          </div>
        </div>
...
<!-- COBRANÇAS -->
        ...
        <div class="row servicecharges">
          <div class="col-md-3 col-xs-6">
            <div class="form-group">
              ...
              <input type="number" step="any" min="0" class="form-control" id="regcol_15" placeholder="A cobrar ao Operador">
            </div>
          </div> 
        <div class="col-md-3 col-xs-6">
          <div class="form-group">
            ...
            <input type="number" step="any" min="0" class="form-control" id="regcol_16" placeholder="A cobrar ao Cliente">
          </div>
        </div> 
        <div class="col-md-3 col-xs-6">
          <div class="form-group">
            <label class="control-label">Cmx Operador</label>
            <input type="number" step="any" min="0" class="form-control" id="regcol_77" placeholder="Cmx Operador">
          </div>
        </div>
        <div class="col-md-3 col-xs-6">
          <div class="form-group">
            <label class="control-label"> Cmx Staff </label>
            <input type="number" step="any" min="0" class="form-control" id="regcol_78" placeholder="Cmx Staff">
          </div>
        </div> 
      </div>
    </div>
    ...
    <div class="modal-footer r">
<!--
      <button onclick="newTransferType(1)" style="float:left;" title="Criar novo registo com dados do atual" type="button" class="btn btn-info btn-repeat">
       <i class="fa fa-repeat" aria-hidden="true"></i>
        <font class="hidden-xs"> Replicar</font>
     </button>

     <button onclick="newTransferType(2)" style="float:left;margin-left:9px;"title="Criar novo registo de Retorno com dados do atual" type="button" class="btn btn-info btn-return">
      <i class="fa fa-exchange" aria-hidden="true"></i>
      <font class="hidden-xs"> Retorno</font>
     </button>
-->
      <button type="button" class="btn btn-default cancel-edit" data-dismiss="modal"><span class="glyphicon glyphicon-remove-sign"></span>
        <font class="hidden-xs"> Fechar</font>
