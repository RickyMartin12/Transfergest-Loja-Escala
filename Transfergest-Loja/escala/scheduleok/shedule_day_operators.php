...
$(".jqx-scheduler-appointment").draggable({axis: "x"});
                 ...
                 if (data == 0){
                  $('.debug-url').html('Erro, ao atribuir ao Operador o Transfer  <b>#'+appointment.id+'</b>!<br><a class="btn btn-warning" href="index.html">Atualizar</a>');
                  $("#Modalko").modal();

              }   
                },
                error:function(){
                 $('.debug-url').html('Erro, ao atribuir ao Operador o Transfer <b>#'+appointment.id+'</b>, p.f. verifique a Acesso Internet');
                 $("#Modalko").modal();
                }
              });
            });   
